...
\section{Additional experience}
    ...
    \subsection{\underline{Teaching}}
        % \cvitem{2022/10}{"Spatial Analysis of Tissues and Organs", CeMM PhD Program, Vienna}
        \cvitem{2022/06}{Invited lecture: "Spatial Analysis of Tissues and Organs", course "Biomedical Informatics \& Genomic Medicine", MSc Molecular Precision Medicine, Medical University of Vienna}
    ...
    \subsection{\underline{Supervision and Mentoring}}
        ...
        \cvitem{2022/01 - }{Zhuoran (Karen) Xu, Data Science Statistician - Weill Cornell Medical College}
        \cvitem{2021/07 - }{Kelsey Chetnik, Staff Associate - Weill Cornell Medical College}
    ...
    \subsection{\underline{Courses attended}}
        % \cvitem{2022/11}{EMBO Lab Leadership Course - EMBO, Heidelberg, Germany}
