...
\section{Patents}
    ...
    \cvitem{\underline{Aproval pending}}{}
        \begin{etaremune}[leftmargin=1.0cm, itemindent=0pt, topsep=10pt, itemsep=2pt, partopsep=0pt, parsep=0pt]
        \item
        \textbf{Methods for determining biological age and/or biological age gap}. \textit{European Patent Office}, October 2024.
...
\section{Communications}
    \cvitem{\underline{Conference talks}}{}
        ...
        \item
        \textbf{Spatially and temporally resolved COVID-19 pathology}. \textit{33rd Annual Conference of the German Society for Cytometry, Berlin, Germany}, October 2023.
        \item
        ...
        \item
        \textbf{The spatial landscape of lung pathology during COVID-19 progression}. \textit{IMC Summit, Singapore}, October 2021.
        \item
...
\section{Additional experience}
    ...
    \subsection{\underline{Teaching}}
        \cvitem{2025 - }{Invited lecture: Weill Cornell Medicine clinical genomics course: "Single-Molecule \& Spatial Sequencing: Methods \& Applications"}
        \cvitem{2024 - }{Bioinformatics course, CeMM PhD Program, Vienna - co-organizor, re-occurs every year}
        \cvitem{2022 - }{Bioinformatics course, CeMM PhD Program, Vienna - one day workshop, re-occurs every year}
        \cvitem{2022 - }{"Spatial Analysis of Tissues and Organs" lecture, CeMM PhD Program, Vienna - re-occurs every year}
        \cvitem{2022 - }{Invited lecture: "Spatial Analysis of Tissues and Organs", course "Biomedical Informatics \& Genomic Medicine", MSc Molecular Precision Medicine, Medical University of Vienna - re-occurs every semester}

    %----------------------------------------------------------------------------------------
    %   MENTORING
    %----------------------------------------------------------------------------------------
    \subsection{\underline{Supervision and Mentoring}}
        \cvitem{2025/09 - }{Shreshta Srivastava, PhD student - LBI-NetMed}
        \cvitem{2025/08 - }{Parijat Chakraborty, Postdoc - LBI-NetMed}
        \cvitem{2023/05 - }{Sabina Tepus, Master student - Boehringer Ingelheim, co-supervisor}
        \cvitem{2024/09 - }{Ariadna Villanueva Marijuan, PhD student - CeMM}
        \cvitem{2024/02 - }{Lisa Kleissl, Postdoc - CeMM}
        ...
        \cvitem{2020/09 - 2024/03}{Junbum (June) Kim, Graduate student - Weill Cornell Graduate School of Medical Sciences}
    ...
    \subsection{\underline{Software}}
        ...
        \cvitem{LazySlide}{
            A package for modular and scalable whole slide image analysis:
            \newline
            \href{https://github.com/RendeiroLab/LazySlide}{https://github.com/RendeiroLab/LazySlide}
        }
        \cvitem{WSIData}{
            Efficient data structures and IO for whole slide image analysis:
            \newline
            \href{https://github.com/RendeiroLab/WSIData}{https://github.com/RendeiroLab/WSIData}
        }
        \cvitem{wsi}{
            A Python package for the processing of whole slide histopathological images:
            \newline
            \href{https://github.com/RendeiroLab/wsi}{https://github.com/RendeiroLab/wsi}
        }
        \cvitem{cytomine\_utils}{
            A package with utilities to interact with Cytomine APIs:
            \newline
            \href{https://github.com/RendeiroLab/cytomine\_utils}{https://github.com/RendeiroLab/cytomine\_utils}
        }
        \cvitem{IMC}{
