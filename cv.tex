...
\cvitem{Bioinformatics}{ChIP-seq data analysis; gene expression data analysis (microarray and RNA-seq); \textit{de novo} transcriptome assembly and annotation; genetic variant detection and annotation; implementation of Hidden Markov Models (HMM) methods}

\subsection{Molecular Biology}
\cvitem{Techniques}{Chromatin imunoprecipitation (ChIP), Illumina library preparation, PCR, qRT-PCR, SDM PCR, molecular cloning, zebrafish and \textit{Nematostella} microinjection, immunohistochemistry/fluorecence and confocal microscopy, Western and Northern blotting}
