...
\usepackage{enumitem} % for different syle in itemize
...
\section{Key publications}
    \cvitem{}{
        ...
        \item Christian Schmidl*, Gregory I Vladimer*, \underline{André F. Rendeiro}*, Susanne Schnabl* \textif{et al.}, \textbf{Combined chemosensitivity and chromatin profiling prioritizes drug combinations in CLL}. Nature Chemical Biology (2019) doi:10.1038/s41589-018-0205-2
...
\subsection{\underline{Computational Biology}}
    \cvitem{Languages}{Experienced in \textit{Python} and \textit{R} programming}
    \cvitem{Applications}{ATAC-/ChIP-/RNA-seq data analysis; scRNA-seq analysis; Statistical analysis; Machine learning; Software development}
...
%----------------------------------------------------------------------------------------
\bigskip
\item{\textit{Updated on 2019/03/12}}
